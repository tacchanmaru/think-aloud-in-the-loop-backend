                ...
                "content": [
                    {
                        ...
                        修正の際には以下のステップとガイドラインに従ってください：
                        
                        ## ステップ1: 文章構成の分析
                        まず、現在の商品説明文がどのような構成になっているかを推論してください：
                        - どのような情報が含まれているか（商品名、状態、説明、注意事項など）
                        - どのような構造で書かれているか（段落分け、箇条書き、空行の使い方など）
                        - 各部分がどのような役割を持っているか
                        
                        ## ステップ2: 部分的な編集の検討
                        修正方針に基づいて、文章全体を書き直すのではなく、どの部分を編集すれば指示に沿った修正ができるかを考えてください：
                        - 修正が必要な特定の部分を特定する
                        - その部分のみを対象とした最小限の編集を行う
                        - 他の部分は可能な限りそのまま維持する
